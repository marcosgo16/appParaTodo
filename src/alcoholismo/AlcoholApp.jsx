...
export default function AlcoholApp() {
  ...
  const S = {
    page: { minHeight: "100vh", background: `radial-gradient(1200px 700px at 50% -200px, #2a170e 0%, ${cl.bg} 55%)`, color: cl.paper, fontFamily: "'DM Sans',system-ui,sans-serif" },
    app: { maxWidth: isDesktop ? 1120 : 460, margin: "0 auto", minHeight: "100vh", display: "flex", flexDirection: "column" },
    hdrBar: { background: `linear-gradient(180deg, ${cl.wood} 0%, ${cl.wood2} 100%)`, position: "sticky", top: 0, zIndex: 100, borderBottom: `1px solid ${cl.line}` },
    hdr: { padding: isDesktop ? "18px 22px 14px" : "16px 18px 12px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 },
    hdrSub: { fontSize: 10, letterSpacing: ".16em", textTransform: "uppercase", color: "rgba(200,164,106,.92)", marginBottom: 2 },
    hdrH1: { fontFamily: "Georgia,serif", fontSize: 21, color: cl.paper, fontWeight: 650, lineHeight: 1.05 },
    ...
    btnOut: { fontSize: 10, padding: "5px 10px", borderRadius: 10, border: `1px solid rgba(200,164,106,.55)`, background: "rgba(0,0,0,.2)", color: cl.paper, cursor: "pointer", fontFamily: "inherit" },
    tabsBar: { background: "rgba(0,0,0,.22)", borderBottom: `1px solid ${cl.line}`, position: "sticky", top: 0, zIndex: 99, backdropFilter: "blur(6px)" },
    tabs: { display: "flex" },
    tab: { flex: 1, padding: "12px 4px", fontSize: 11, fontWeight: 600, letterSpacing: ".12em", textTransform: "uppercase", textAlign: "center", cursor: "pointer", border: "none", borderBottom: "2px solid transparent", background: "none", color: "rgba(243,233,218,.62)" },
    tabOn: { color: cl.paper, borderBottom: `2px solid ${cl.brass}` },
    sec: { padding: isDesktop ? 22 : 16, flex: 1 },
    card: { background: "rgba(255,255,255,.04)", border: `1px solid rgba(255,255,255,.08)`, borderRadius: 16, padding: 16 },
    cardTitle: { fontFamily: "Georgia,serif", fontSize: 16, marginBottom: 12 },
    fg: { marginBottom: 12 },
    flbl: { display: "block", fontSize: 11, fontWeight: 600, letterSpacing: ".12em", textTransform: "uppercase", color: "rgba(243,233,218,.68)", marginBottom: 6 },
    finput: { width: "100%", padding: "10px 12px", border: `1px solid rgba(255,255,255,.14)`, borderRadius: 12, fontFamily: "inherit", fontSize: 13, color: cl.paper, background: "rgba(0,0,0,.26)", outline: "none" },
    frow: { display: "grid", gridTemplateColumns: isDesktop ? "1fr 1fr 1fr" : "1fr", gap: 10, marginBottom: 12 },
    btn: { padding: 12, borderRadius: 12, fontFamily: "inherit", fontSize: 13, fontWeight: 700, cursor: "pointer", border: "none" },
    btnP: { background: cl.brass, color: cl.ink },
    ...
    row: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, padding: "12px 12px", borderRadius: 14, border: `1px solid rgba(255,255,255,.08)`, background: "rgba(0,0,0,.18)" },
    rowLeft: { display: "flex", alignItems: "center", gap: 10, minWidth: 0 },
    badge: { width: 34, height: 34, borderRadius: 12, display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(200,164,106,.14)", border: "1px solid rgba(200,164,106,.24)", fontSize: 18, flexShrink: 0 },
    rowTitle: { fontWeight: 700, fontSize: 13, lineHeight: 1.2, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" },
    rowMeta: { fontSize: 11, color: "rgba(243,233,218,.65)", marginTop: 2 },
